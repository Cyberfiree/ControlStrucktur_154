...
#Tugas 2
# meminta pengguna untuk memberikan 3 nilai yg berbeda
a = float(input("Enter the first number: "))
b = float(input("Enter the second number: "))
c = float(input("Enter the third number: "))

# Mencari angka paling besar dari ketiga nilai yg diinput
if a >= b and a >= c:
    largest = a
elif b >= a and b >= c:
    largest = b
...
#Tugas 4 Mencetak Bilangan Ganjil Hingga Nilai n
